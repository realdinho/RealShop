...
class PayPal
{
    ...
    // your paypal id
    private $_business = 'felerminoali_seller@outlook.com';
    // page style
...
//
//        // check if post has been received from paypal.com -- or -- ec2.internal
////        if (!preg_match('/paypal\.com$/', $hostname)) {
//        if (!preg_match('/ec2\.internal$/', $hostname)) {
//
//            $fp = fopen(ROOT_PATH . DS . "log" . DS . "error.log", 'a');
//            $text = 'An error has occurred ';
//            $text .= ' IP: ' . $_SERVER['REMOTE_ADDR'] . ' ';
//            $text .= !empty($hostname) ? ' hostname ' . $hostname : 'not';
//            $text .= ' found \n .... ';
//
//            fwrite($fp, $text);
//
...
//
//            $fp = fopen(ROOT_PATH . DS . "log" . DS . "error.log", 'a');
//            $text = 'check business email failed :-( \n ';
//            fwrite($fp, $text);
//
//            fclose($fp);
//            
...
//
//            $fp = fopen(ROOT_PATH . DS . "log" . DS . "error.log", 'a');
//            $text = 'Error while validating IPN :-( \n ';
//            fwrite($fp, $text);
//            fclose($fp);
//
//        }
