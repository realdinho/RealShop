        ...
        <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
            ...
            <tr>
                ...
                <td>
                    ...
                    <textarea name="address" id="address" cols="" rows="" class="tar">
                        <?php echo $objForm->stickyText('address', $business['address']); ?>
                    </textarea>
                </td>
            </tr>
            ...
            <tr>
                <th><label for="vat_rate">Town: *</label></th>
                <td>
                    <?php echo $objValid->validate('vat_rate'); ?>
                    <input type="text" name="vat_rate" id="vat_rate" class="fld"
