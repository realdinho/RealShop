...
if (!empty($id)) {
    ...
    if (!empty($product)) {
        ...
        if ($objForm->isPost('name')) {
            ...
            if ($objValid->isValid()) {
                if (!empty($objCatalogue->updateProduct($objValid->_post, $id))) {
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="tbl_insert">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="name" id="name" value="<?php echo $objForm->stickyText('name', $product['name']); ?>"
                               class="fld">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="price" id="price" value="<?php echo $objForm->stickyText('price', $product['price']); ?>"
                               class="fld_price">
                    </td>
                </tr>
